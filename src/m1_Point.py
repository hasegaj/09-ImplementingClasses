...
# -----------------------------------------------------------------------------
# DO: 2.          With your instructor, READ THE INSTRUCTIONS in
# DO (continued)  in file  m0_INSTRUCTIONS.txt, asking questions as needed.
#
...
class Point(object):
    ...
    def closer_to(self, p1, p2):
        ...
        c2 = (a2**2 + b2**2)**.5
        if c1>c2:
            return 'point 1 is closer'
        else:
            return 'point 2 is closer'
...
def run_test_move_by():
    ...
    You may also use this example to test this method.
        ...
        """
    # -------------------------------------------------------------------------
    # DO: 7.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    # DO (continued):  HINT: What must a Point REMEMBER for this method?
    # -------------------------------------------------------------------------
    print()
    print('-----------------------------------------------------------')
